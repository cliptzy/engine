...
class SFXManager:
    ...
    def _load_default(self):
        self.sfx_map = {
            ...
            "happy": {"desc": "Senang, antusias (excited), memuji (\"keren\", \"mantap\"), menang, berhasil, atau hadiah.", "files": ["whoosh.mp3", "whip.mp3", "switch-sound.mp3", "anime-wow.mp3", "rizz.mp3", "ding.mp3", "money.mp3", "meccha-whistle.mp3", ""]},
            "amused": {"desc": "Lucu, terhibur, tertawa (\"haha\", \"wkwk\", \"bjir\"), komedi troll, atau sarkasme ringan.", "files": ["whoosh.mp3", "whip.mp3", "switch-sound.mp3", "funny.mp3", "hihihiha-royale.mp3", "pop.mp3", "slip.mp3", ""]},
        }
