...
def test_text_emotion(text: str):
    try:
        ...
        print(json.dumps({"error": "Modul 'transformers' atau 'torch' belum terinstall."}, indent=2))
        return
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Proof of Concept for Text Emotion Detection menggunakan StevenLimcorn/indonesian-roberta-base-emotion-classifier")
    parser.add_argument("text", type=str, help="Teks bahasa Indonesia yang akan dianalisis emosinya")
